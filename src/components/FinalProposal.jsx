      ...
      <AnimatePresence mode="wait">
        {!answered ? (
          ...
          >
            ...
            <div
              className="absolute -inset-10 sm:-inset-14 rounded-3xl"
              style={{
            ...
            {/* Animated heart */}
            <motion.div
              className="relative text-7xl md:text-8xl mb-8"
            ...
            {/* The question */}
            <motion.h1
              className="relative text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-extralight tracking-tight mb-4"
            ...
            <motion.p
              className="relative text-base sm:text-lg text-violet-200/60 font-light mb-20 max-w-sm sm:max-w-md"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
...
function CelebrationView() {
  ...
  return (
    ...
    >
      ...
      <motion.h1
        className="text-3xl sm:text-4xl md:text-6xl font-extralight tracking-tight mb-4"
        style={{ fontFamily: "'Cormorant Garamond', Georgia, serif" }}
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
      ...
      <motion.p
        className="text-violet-200/60 text-base font-light max-w-sm mt-2"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
